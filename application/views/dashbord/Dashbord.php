...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/open-iconic-bootstrap.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/animate.css">
    
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/magnific-popup.css">

    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/aos.css">

    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/ionicons.min.css">

    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/bootstrap-datepicker.css">
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/jquery.timepicker.css">

    
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/flaticon.css">
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/icomoon.css">
    <link rel="stylesheet" href="<?= base_url() ?>/vendor/dashbord/css/style.css">
  </head>
  <body>
                ...
                <div class="testimony-wrap py-4">
                  <div class="text">
                    ...
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url('<?= base_url() ?>/vendor/dashbord/images/person_1.jpg')"></div>
                    	<div class="pl-3">
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url('<?= base_url() ?>/vendor/dashbord/images/person_2.jpg')"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
              ...
              <div class="item">
                <div class="testimony-wrap py-4">
                  <div class="text">
                    <p class="mb-4">Far far away, behind the word mountains, far from the countries Vokalia and Consonantia, there live the blind texts.</p>
                    <div class="d-flex align-items-center">
                    	<div class="user-img" style="background-image: url('<?= base_url() ?>/vendor/dashbord/images/person_3.jpg')"></div>
                    	<div class="pl-3">
		                    <p class="name">Roger Scott</p>
		                    <span class="position">Marketing Manager</span>
		                  </div>
    ...
    <section class="ftco-section ftco-agent ftco-no-pt">
        ...
        <div class="row">
        	<div class="col-md-3 ftco-animate">
        		<div class="agent">
    					<div class="img">
		    				<img src="<?= base_url() ?>/vendor/dashbord/images/team-1.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="desc">
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="agent">
    					<div class="img">
		    				<img src="<?= base_url() ?>/vendor/dashbord/images/team-2.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="desc">
	    					<h3><a href="properties.html">James Stallon</a></h3>
								<p class="h-info"><span class="location">Listing</span> <span class="details">&mdash; 10 Properties</span></p>
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="agent">
    					<div class="img">
		    				<img src="<?= base_url() ?>/vendor/dashbord/images/team-3.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="desc">
	    					<h3><a href="properties.html">James Stallon</a></h3>
								<p class="h-info"><span class="location">Listing</span> <span class="details">&mdash; 10 Properties</span></p>
        	...
        	<div class="col-md-3 ftco-animate">
        		<div class="agent">
    					<div class="img">
		    				<img src="<?= base_url() ?>/vendor/dashbord/images/team-4.jpg" class="img-fluid" alt="Colorlib Template">
	    				</div>
	    				<div class="desc">
	    					<h3><a href="properties.html">James Stallon</a></h3>
  ...
  <script src="<?= base_url() ?>/vendor/dashbord/js/jquery.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/popper.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/bootstrap.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/jquery.easing.1.3.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/jquery.waypoints.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/jquery.stellar.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/owl.carousel.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/jquery.magnific-popup.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/aos.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/jquery.animateNumber.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/bootstrap-datepicker.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/jquery.timepicker.min.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/google-map.js"></script>
  <script src="<?= base_url() ?>/vendor/dashbord/js/main.js"></script>
